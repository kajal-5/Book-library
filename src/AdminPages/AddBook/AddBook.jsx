      ...
      <div className="flex-1 flex justify-center items-center p-6">
        <div className="w-full max-w-5xl rounded-2xl shadow-2xl p-8 flex flex-col md:flex-row gap-8 bg-indigo-100 backdrop-blur-sm">
          ...
          <form
            ...
            className="md:w-[60%] bg-gradient-to-br from-blue-500 via-purple-500  to-pink-500 rounded-xl p-6 shadow-lg"
          >
            <h2 className="text-2xl py-4 font-bold text-gray-800 text-center mb-6 bg-gradient-to-r from-red-950 to-purple-800 bg-clip-text text-transparent">
              Add New Book
            </h2>
          ...
          <div className="md:w-[40%] flex flex-col items-center justify-center rounded-xl p-6 bg-gradient-to-br from-purple-500 to-pink-300 shadow-lg">
            <h3 className="text-2xl font-bold mb-6 bg-gradient-to-r from-purple-800 to-pink-700 bg-clip-text text-transparent">
              Preview
            </h3>
            <div className="w-64 bg-white rounded-xl shadow-xl overflow-hidden border-2 border-gray-200 hover:shadow-lg transition-all">
              ...
              <div className="p-6 bg-gradient-to-br from-blue-50 to-purple-50">
                <h4 className="font-bold text-xl mb-3 text-gray-800 truncate">
                  {form.name || "Book Name"}
                </h4>
                {form.description && (
