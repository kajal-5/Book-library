...
const EditBookDetails = ({ book, isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 rounded-3xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-hidden border-4 border-white"
